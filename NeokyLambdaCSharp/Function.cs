...
using NeokyLambdaCSharp.Triggers;
using Amazon.Lambda.Serialization.SystemTextJson;

// Assembly attribute to enable the Lambda function's JSON input to be converted into a .NET class.
//[assembly: LambdaSerializer(typeof(Amazon.Lambda.Serialization.Json.DefaultLambdaJsonSerializer))]
// Assembly attribute to enable the Lambda function's JSON input to be converted into a .NET class.
[assembly: LambdaSerializer(typeof(Amazon.Lambda.Serialization.Json.JsonSerializer))]

namespace NeokyLambdaCSharp // UserPoolTriggers
{
    ...
    {       
        ...
        public JObject FunctionCognitoHandler(JObject cognitoTriggerEvent, ILambdaContext context)
        {
            ...
            switch (triggerSource)
            {
                ...
                case "PostConfirmation_ConfirmSignUp":
                    ...
                    var triggerPostConfirmationEvent = cognitoPostConfirmation.FunctionHandler(cognitoTriggerEvent.ToObject<PostConfirmationBase>(), context);
